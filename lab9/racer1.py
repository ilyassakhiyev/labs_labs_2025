...
background = pygame.image.load("AnimatedStreet (1).png")
...
class Coin(pygame.sprite.Sprite):
    def __init__(self, enemy,size):
        super().__init__()
        if size == "small":
            self.image = pygame.image.load("small_coin.png")
        elif size == "medium":
            self.image = pygame.image.load("med_coin.png")
        elif size == "large":
            self.image = pygame.image.load("big_coin.png")
        self.rect = self.image.get_rect()
