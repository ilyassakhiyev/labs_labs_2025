...
pygame.mixer.music.load('Imagine Dragons - Believer.mp3')
pygame.mixer.music.play()

_songs = ['Imagine Dragons - Believer.mp3','muzart-toby-sh-oyr_(muzzona.kz).mp3', 'Offenbach - Can Can.mp3', 'Queen - Bohemian Rhapsody.mp3', 'Виктор Цой - Группа крови.mp3']
